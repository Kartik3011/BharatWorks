        ...
        <div className="sections">
          <div className="info">
            ...
            <select name="cats" id="cats">
              ...
              <option value="animation">CyberSecurity</option>
              <option value="animation">UI/UX Design</option>
              <option value="animation">Artificial Intelligence</option>
              <option value="animation">DropShipping</option>
